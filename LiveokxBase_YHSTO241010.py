...
print("Auto-LiveokxBase_YHSTO241010 Detected Bot started")
...
def trading_bot():
    ...
    while True:
        ...
        # 스토캐스틱 크로스업에서 매수 주문 (MACD 크로스업이 아닐 때만)
        ...
        # 1분마다 상황 출력
        if time.time() - last_print_time >= 60:  # 60초 = 1분
